...
if(print_all):
    ...
    #"""
    if(mu is not None):
        print(f" {'mu':<10}  {'Etot':<10}  {'Etot_err':<10}  {'E_U':<10}  {'E_U_err':<10}  {'E_K':<10}  {'E_K_err':<10}  {'ntot':<10}  {'ntot_err':<10}  {'nn_corr':<10}  {'nn_corr_err':<10}  {'szsz_corr':<10}  {'szsz_corr_err':<10}")
        print(f"{mu: 10.8f} {Etot: 10.8f} {Etot_err: 10.8f} {Ehubb: 10.8f} {Ehubb_err: 10.8f} {Eonebody: 10.8f} {Eonebody_err: 10.8f} {ntot: 10.8f} {ntot_err: 10.8f} {np.mean(nn_corr).real: 10.8f} {nn_corr_err.real: 10.8f} {np.mean(szsz_corr).real: 10.8f} {szsz_corr_err.real: 10.8f}")
    else:
        print(f"  {'Etot':<10}  {'Etot_err':<10}  {'E_U':<10}  {'E_U_err':<10}  {'E_K':<10}  {'E_K_err':<10}  {'ntot':<10}  {'ntot_err':<10}  {'nn_corr':<10}  {'nn_corr_err':<10}  {'szsz_corr':<10}  {'szsz_corr_err':<10}")
        print(f" {Etot: 10.8f} {Etot_err: 10.8f} {Ehubb: 10.8f} {Ehubb_err: 10.8f} {Eonebody: 10.8f} {Eonebody_err: 10.8f} {ntot: 10.8f} {ntot_err: 10.8f} {np.mean(nn_corr).real: 10.8f} {nn_corr_err.real: 10.8f} {np.mean(szsz_corr).real: 10.8f} {szsz_corr_err.real: 10.8f}")
